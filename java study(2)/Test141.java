...
객체를 생성하지 않고 바로 접급하여 사용하는 것이 가능하다.

○java.lang.Mate 클래스의 주요 상수 및 메소드
-public static final double E =2.71......;
:자연 로그 상수

-public static final double PI =3.141592......;
: 원주율(Π) //ㅎ에서 파이 기호 찾으면 된다.
...
public class Test141
{
	...
	{
		System.out.println("원주율	    : " +Math.PI); //속성값이나 메소드 값에 직접 접근해서 쓰기
		System.out.println("2의 제곱근	: " +Math.sqrt(2)); //속성값이나 메소드 값에 직접 접근해서 쓰기
		...
		// 0.0 ~ 1.0 사이의 난수 : 0.42418254743730566
		// 0.0 ~ 1.0 사이의 난수 : 0.4260247168289021
		// 0.0 ~ 1.0 사이의 난수 : 0.7481540356109417
		// 0.0 ~ 1.0 사이의 난수 : 0.3786080131582209
		// 0.0 ~ 1.0 사이의 난수 : 0.2369806564969883
		// 0 이랑 1 안 나옴 이 사이에 있는 실수들만 결과값으로 출력
